...
import com.santiagow.demo.http.BaseHttpResponseListener;
...
import static com.santiagow.demo.http.mock.MockHttpServerHandler.ApiPath;
...
public class MockHttpServerTest {
	...
	public void setup() throws Exception {
		...
		saveBody = getContentByFileName("com/santiagow/demo/http/save.json");
		queryBody = getContentByFileName("com/santiagow/demo/http/query.json");
		updateBody = getContentByFileName("com/santiagow/demo/http/update.json");
		removeBody = getContentByFileName("com/santiagow/demo/http/remove.json");
	}
